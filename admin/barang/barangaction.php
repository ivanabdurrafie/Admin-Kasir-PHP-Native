...
if(isset($_POST['update'])){
  ...
  for($i=0;$i<$cnt;$i++)
   {
     $del_id=$chkbox[$i];
     $query="select * from barang where idBarang=".$del_id;
     $conn->query($query);
    //  $message = "data successfully deleted";
    //  echo "<script type='text/javascript'>alert('$message');
    //  window.location.href = 'barangtabel.php';
								...
								<div class="panel-body">
									<form action="baranginsertaction.php" class="form-horizontal" method="post" enctype="multipart/form-data">
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" id="inputDefault" name="nama" value="<?php echo"$row['Nama']";?>">
											</div>
											
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label" for="inputDefault">Stok</label>
											<div class="col-md-7">
												<input type="number" class="form-control" id="inputDefault" name="stok" value="<?php echo"$row['stok']";?>">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label" for="inputDefault">Harga</label>
											<div class="col-md-7">
												<input type="number" class="form-control" id="inputDefault" name="harga" value="<?php echo"$row['Harga']";?>">
											</div>
										</div>
										<div class="form-group">
										<label class="col-md-3 control-label">File Upload</label>
											<div class="col-md-9">
												<div class="fileupload fileupload-new" data-provides="fileupload">
													<input type="file" name="file" class="fileupload-new" id="">
												</div>
											</div>
										</div>
										<div class="form-group">

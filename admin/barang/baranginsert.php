								...
								<div class="panel-body">
									<form action="baranginsertaction.php" class="form-horizontal" method="post" enctype="multipart/form-data">
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="text" class="form-control" id="inputDefault" name="nama" placeholder="Shampoo">
											</div>
										...
										<div class="form-group">
											...
											<div class="col-md-7">
												<input type="number" class="form-control" id="inputDefault" name="stok" placeholder="12">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label" for="inputDefault">Harga</label>
											<div class="col-md-7">
												<input type="number" class="form-control" id="inputDefault" name="harga" placeholder="12">
											</div>
										</div>
										<div class="form-group">

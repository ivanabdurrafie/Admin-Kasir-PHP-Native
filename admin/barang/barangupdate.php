							...
							<div class="panel-body">
								<form action="barangupdateaction.php" class="form-horizontal" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-md-7">
											<input type="number" class="form-control" id="inputDefault" name="stok" value="<?php echo $stok; ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-3 control-label" for="inputDefault">Harga</label>
										<div class="col-md-7">
											<input type="number" class="form-control" id="inputDefault" name="harga" value="<?php echo $harga; ?>">
										</div>
									</div>
									<div class="form-group">

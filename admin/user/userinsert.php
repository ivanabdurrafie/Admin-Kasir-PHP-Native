						...
						<div class="col-lg-12">
							<section class="panel">
								...
								<div class="panel-body">
									<form action="userinsertaction.php" class="form-horizontal" method="post" enctype="multipart/form-data">
										<div class="form-group">
											<label class="col-md-3 control-label" for="inputDefault">Username</label>
											<div class="col-md-7">
												<input type="text" class="form-control" id="inputDefault" name="username" placeholder="iabdurrafie">
											</div>	
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label" for="inputDefault">Email</label>
											<div class="col-md-7">
												<input type="email" class="form-control" id="inputDefault" name="email" placeholder="iabdurrafie@gmail.com">
											</div>	
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label" for="inputDefault">Password</label>
											<div class="col-md-7">
												<input type="password" class="form-control" id="inputDefault" name="password" placeholder="********">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label" for="inputDefault">Nama</label>
											<div class="col-md-7">
												<input type="nama" class="form-control" id="inputDefault" name="nama" placeholder="Anastasia">
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label" for="inputDefault">Alamat</label>
											<div class="col-md-7">
												<textarea name="alamat" id="inputDefault" class="form-control" cols="30" rows="3" placeholder="malang"></textarea>
											</div>
										</div>
										<div class="form-group">
